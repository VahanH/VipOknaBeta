            ...
            <div class="panel-body">
                <div class="">
                    <select class="form-control input-sm">
                        ...
                        <option value="">Novotex 58мм</option>
                        <option value="">Novotex 70мм</option>
                        <option value="">Exprof 46мм</option>
                        <option value="">Exprof 58мм</option>
                        <option value="">Exprof 70мм</option>
                    </select>
                </div>
